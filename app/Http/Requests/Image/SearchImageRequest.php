...
class SearchImageRequest extends FormRequest
{
    ...
    public function queryParameters(): array
    {
        return [
            ...
            'technique' => ['description' => 'Filtra por UUIDs de técnicas (vrac-techniques).', 'type' => 'string[]', 'example' => 'No-example'],
            'technique.*' => ['description' => '', 'example' => null],
            'work_type' => ['description' => 'Filtra por UUIDs de tipos de obra (vrac-work-types).', 'type' => 'string[]', 'example' => 'No-example'],
            'work_type.*' => ['description' => '', 'example' => null],
            'material' => ['description' => 'Filtra por UUIDs de materiais (vrac-materials).', 'type' => 'string[]', 'example' => 'No-example'],
            'material.*' => ['description' => '', 'example' => null],
            'style_period' => ['description' => 'Filtra por UUIDs de períodos/estilos (vrac-style-periods).', 'type' => 'string[]', 'example' => 'No-example'],
            'style_period.*' => ['description' => '', 'example' => null],
            'cultural_context' => ['description' => 'Filtra por UUIDs de contextos culturais (vrac-cultural-contexts).', 'type' => 'string[]', 'example' => 'No-example'],
            'cultural_context.*' => ['description' => '', 'example' => null],
            ...
            'work_date_from' => ['description' => 'Filtra imagens cujas obras têm data mais antiga >= este valor (formato: AAAA-MM-DD).', 'example' => '1950-01-01'],
            'work_date_to' => ['description' => 'Filtra imagens cujas obras têm data mais recente <= este valor (formato: AAAA-MM-DD).', 'example' => '1980-12-31'],
    ...
    public function rules(): array
    {
        return [
            ...
            'material.*' => 'uuid',
            'style_period' => 'nullable|array',
            'style_period.*' => 'uuid',
            'cultural_context' => 'nullable|array',
            'cultural_context.*' => 'uuid',
            'date_from' => 'nullable|date_format:Y-m-d',
            'date_to' => 'nullable|date_format:Y-m-d',
            'work_date_from' => 'nullable|date_format:Y-m-d',
            'work_date_to' => 'nullable|date_format:Y-m-d',
            ...
            'binomial' => 'nullable|array',
            'binomial.*' => 'string|in:left,right',
